...
var TCLIService_GetLog_args = function(args) {
  this.req = null;
  if (args) {
    if (args.req !== undefined && args.req !== null) {
      this.req = new ttypes.TGetLogReq(args.req);
    }
  }
};
...
var TCLIService_GetLog_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.TGetLogResp(args.success);
    }
  }
};
...
TCLIServiceClient.prototype.send_GetLog = function(req) {
  ...
  var args = new TCLIService_GetLog_args(params);
  try {
...
TCLIServiceProcessor.prototype.process_GetLog = function(seqid, input, output) {
  ...
  if (this._handler.GetLog.length === 1) {
    Q.fcall(this._handler.GetLog.bind(this._handler),
      args.req
    ).then(function(result) {
      var result_obj = new TCLIService_GetLog_result({success: result});
      ...
      var result;
      result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
      output.writeMessageBegin("GetLog", Thrift.MessageType.EXCEPTION, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
    });
    ...
    this._handler.GetLog(args.req, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new TCLIService_GetLog_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("GetLog", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("GetLog", Thrift.MessageType.EXCEPTION, seqid);
